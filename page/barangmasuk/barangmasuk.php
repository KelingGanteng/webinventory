    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="databarangmasuk" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Id Transaksi</th>
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $sql = $koneksi->query("SELECT id_transaksi, tanggal, kode_barang, nama_barang, jumlah, satuan FROM barang_masuk");
